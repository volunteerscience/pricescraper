...
/*
{"chain":[{"contents-20":"+$"},{"sibling-":{"chain":[{"contents-20":"+trip"}]}}]},{"name":"temp_prices"}]}
{"chain":[{"contents-20":"+$"},{"tag-":"=div"}]}
{"chain":[{"contents-20":"+trip"}]}
{"chain":[{"contents-20":"+stop"}]}
{"chain":[{"contents-30":"[+l]pm – "}, {"visibility-":"visible"}]}]}
{"chain":[{"contents-30":"+similar flights"}]}
{"chain":[{"nav-":"next"}]}
{"chain":[{"nav-":"prev"}]}
{"chain":[{"nav-":"next"}]}
{"chain":[{"nav-":"next"}]}
